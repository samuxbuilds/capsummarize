...
export namespace Manifest {
  export type WebExtensionManifestType = WebExtensionManifest;
  export type ContentScriptType = ContentScript;
  export type WebAccessibleResourceType = WebAccessibleResource;
}
